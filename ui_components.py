...
# Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Unified Stunning Styles (Applied everywhere) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
def git_status_badge(connected: bool):
    ...
    if connected:
        return '<span class="git-status-connected">Ã¢â€”Â CONNECTED</span>'
    return '<span class="git-status-disconnected">Ã¢â€”â€¹ DISCONNECTED</span>'
...
def render_onboarding_tour():
    ...
    if st.session_state.get("show_onboarding", True):
        with st.expander("Ã°Å¸Å½â€œ Welcome! Take a Quick Tour", expanded=True):
            st.markdown("""
            ### Ã°Å¸â€˜â€¹ Welcome to the Advanced Research Data Analyzer!

            This powerful tool replaces **SPSS, Tableau, and Power BI**  all in one free, Notion-connected platform.

            **Ã°Å¸â€œÂ Quick Navigation:**
            - ** Live Dashboard**  Real-time sync with your Notion database
            - **Ã°Å¸â€œÂ File Analyzer**  Upload CSV, Excel, SPSS, SAS, STATA files
            - **Ã°Å¸â€Â¬ Statistical Tests**  T-tests, ANOVA, Correlation, Regression, and more
            - **ðŸ“ˆ Advanced Visuals**  18 chart types with auto-recommendation
            - **Ã°Å¸Â¤â€“ CHRISHEM Insights**  Automated data analysis and smart recommendations
            - **Ã°Å¸â€â€” Git Integration**  Connect GitHub for data version control
            - ** Presentation Deck**  Build interactive slide decks
            - **Ã¢Å¡â„¢Ã¯Â¸Â Settings**  Theme, credentials, keep-alive configuration
