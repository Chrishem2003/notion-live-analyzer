    ...
    if task_type == "Classification":
        ...
        if st.button("ðŸš€ Run Auto Classification", type="primary"):
            ...
            if "error" in results:
                ...
                st.dataframe(results["results"], width='stretch', hide_index=True)
        ...
        if st.button("ðŸš€ Run Clustering", type="primary"):
            ...
            if "error" in results:
                ...
                st.dataframe(results.get("profiles", pd.DataFrame()), width='stretch')
        ...
        if st.button("ðŸš€ Run Forecast", type="primary"):
            ...
            if "error" in results:
                ...
                if hist is not None and fore is not None:
                    ...
                    st.dataframe(fore, width='stretch', hide_index=True)
