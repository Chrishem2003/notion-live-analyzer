...
def render_audit_tab(db, project_id, local_sources=None, clearance=False):
    ...
    if portal_tab == "🔬 Professor & Evaluator Command Center":
        ...
        col_m3.metric("⏱️ Avg. Completion Time", "4 + h 18 + m", "-24 + m baseline")
        col_m4.metric("🛡️ Auto-Dispatched Reports", "38", "100% success")

        st.markdown("#### 📋 Active Submission Queue & Manipulation Matrix")
        
        mock_submissions = [
            {"id": "SUB-101", "student": "Amuge Agnes", "paper": "Genomic Sequencing Variance.pdf", "copying_pct": "84%", "ai_score": "91%", "time_taken": "12 + m 45 + s", "status": "🚩 Flagged (High Manipulation)"},
            ...
            {"id": "SUB-103", "student": "Atim Susan", "paper": "Waterborne Pathogen Resistance.txt", "copying_pct": "45%", "ai_score": "38%", "time_taken": "2 + h 05 + m", "status": "⚠️ Moderate Review"},
            {"id": "SUB-104", "student": "Egwea Aaron", "paper": "Agri-Tech Data Framework.pdf", "copying_pct": "92%", "ai_score": "96%", "time_taken": "4 + m 10 + s", "status": "🚨 Critical Breach (Paste-Storm)"},
        ]
