...
def render_audit_tab(db, project_id, local_sources=None, clearance=False):
    if not clearance:
        st.warning("Ã°Å¸â€â€™ **Restricted Security Zone**: Enter Level-1 Admin Passkey in the access control panel above to unlock Professor metrics, telemetry, and automated compliance routing.")
        return

    st.markdown("---")
    
    # Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Direct Local Browser Ingestion (Unlimited Words & Downloads) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    with st.expander("Ã°Å¸â€œâ€š Direct Local Document Ingestion & Unlimited Bypass Gateway", expanded=not local_sources):
    ...
    portal_tab = st.selectbox(
        ...
        [
            "Ã°Å¸â€Â¬ Professor & Evaluator Command Center", 
            "Ã°Å¸Å½â€œ Student Workspace & Advanced Humanizer", 
            " Analytics, Graphs & Forensic Traceback", 
            "Ã¢Å¡Â¡ Automated Compliance Dispatcher"
        ],
    ...
    if portal_tab == "Ã°Å¸â€Â¬ Professor & Evaluator Command Center":
        st.markdown("### Ã°Å¸â€Â¬ Professor Forensic Review Dashboard")
        ...
        col_m2.metric("Ã°Å¸Å¡Â¨ High Risk / Flagged", "4", "Action Required")
        col_m3.metric("Ã¢ÂÂ±Ã¯Â¸Â Avg. Completion Time", "4 + h 18 + m", "-24 + m baseline")
        col_m4.metric("Ã°Å¸â€ºÂ¡Ã¯Â¸Â Auto-Dispatched Reports", "38", "100% success")

        st.markdown("#### ðŸ“‹ Active Submission Queue & Manipulation Matrix")
        
        mock_submissions = [
            {"id": "SUB-101", "student": "Amuge Agnes", "paper": "Genomic Sequencing Variance.pdf", "copying_pct": "84%", "ai_score": "91%", "time_taken": "12 + m 45 + s", "status": "Ã°Å¸Å¡Â© Flagged (High Manipulation)"},
            ...
            {"id": "SUB-103", "student": "Atim Susan", "paper": "Waterborne Pathogen Resistance.txt", "copying_pct": "45%", "ai_score": "38%", "time_taken": "2 + h 05 + m", "status": "Ã¢Å¡Â Ã¯Â¸Â Moderate Review"},
            {"id": "SUB-104", "student": "Egwea Aaron", "paper": "Agri-Tech Data Framework.pdf", "copying_pct": "92%", "ai_score": "96%", "time_taken": "4 + m 10 + s", "status": "Ã°Å¸Å¡Â¨ Critical Breach (Paste-Storm)"},
        ]
...
"""
    ...
    elif portal_tab == "Ã°Å¸Å½â€œ Student Workspace & Advanced Humanizer":
        st.markdown("### Ã°Å¸Å½â€œ Student Writing Suite & Unlimited High-Grade Humanizer")
        ...
        with col_txt1:
            st.markdown("#### Ã¢Å“ÂÃ¯Â¸Â Unlimited Drafting & Ingestion Workspace")
        ...
        with col_txt2:
            ...
            if st.button("Ã°Å¸Å¡â‚¬ Execute Unlimited High-Grade Humanization", type="primary"):
        ...
        tab_g1, tab_g2, tab_g3 = st.tabs(["ðŸ“ˆ Session Time vs Copying %", "Ã°Å¸Â§Â¬ Source Plagiarism Breakdown", "Ã°Å¸â€â€” Blockchain Audit Trail"])
        ...
        st.markdown("### Ã¢Å¡Â¡ Automated Compliance Dispatcher & Proof Engine")
        ...
        st.info("Ã°Å¸â€™Â¡ Packages copying percentages, time taken, and telemetry data into cryptographic proof reports automatically sent to evaluators.")
        
        with st.form("dispatch_config_form"):
            st.markdown("#### Ã¢Å¡â„¢Ã¯Â¸Â Dispatch Settings")
