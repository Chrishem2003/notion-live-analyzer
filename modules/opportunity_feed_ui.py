        ...
        with cols[i]:
            ...
            st.markdown(
                ...
                <div style="background:#0b1321;border:1px solid #6366f155;border-radius:14px;padding:1rem;height:100%;">
                    ...
                    <div style="color:#94a3b8;font-size:0.75rem;">{amount or 'Amount varies'} Â· {opp.get('field_of_study','')}</div>
                </div>
                """,
                        ...
                        <div style="flex:1;min-width:0;">
                            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:0.5rem;">
                                <div>
                                    ...
                                    <div style="color:#818cf8;font-size:0.78rem;">{opp.get('organization','')} Â· {opp.get('source_authority','')}</div>
                                </div>
                            ...
                            <div style="color:#94a3b8;font-size:0.78rem;line-height:1.5;">{opp.get('description','')[:220]}{'â€¦' if len(opp.get('description',''))>220 else ''}</div>
