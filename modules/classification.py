"""
classification.py â€” Real access-control levels for Drive (and, later, Docs/
...
string from this same list â€” compare positions, nothing fancier, nothing
...
def can_delete(user_clearance: str, file_classification: str, is_owner: bool) -> bool:
    ...
    clearance (the top tier) regardless of the file's own level â€” deletion
...
def clearance_for_user(is_admin: bool) -> str:
    ...
    This is a real, if coarse, policy â€” not a placeholder that always
