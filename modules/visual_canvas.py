...
def render_hybrid_visual_canvas():
    st.subheader("ðŸŽ›ï¸ ResearchOS Hybrid Industrial Visual Intelligence Core")
    ...
    st.markdown("### âœˆï¸ System Synthetic Flight Director (HUD Telemetry)")
    ...
    st.markdown("### ðŸ§ª Automated Process & Instrumentation Diagram (P&ID Flow)")
    ...
    <div style="background-color: #0e1117; padding: 20px; border-radius: 10px; border: 1px solid #30363d; font-family: monospace; color: #c9d1d9;">
        <h4 style="margin-top: 0; color: #58a6ff;">âš¡ ResearchOS Active Pipeline Matrix</h4>
        <div style="display: flex; justify-content: space-between; align-items: center; text-align: center; gap: 10px;">
            <div style="background: #1f6feb; padding: 15px; border-radius: 8px; flex: 1;">
                <strong>[01] Ingestion</strong><br><span style="font-size: 11px; color: #8b949e;">Polyglot Normalizer</span><br>ðŸŸ¢ ACTIVE
            </div>
            <div style="color: #8b949e; font-size: 20px;">âž”</div>
            <div style="background: #238636; padding: 15px; border-radius: 8px; flex: 1;">
                <strong>[02] Sanitization</strong><br><span style="font-size: 11px; color: #8b949e;">FAIR Schema Engine</span><br>ðŸŸ¢ LOCKED
            </div>
            <div style="color: #8b949e; font-size: 20px;">âž”</div>
            <div style="background: #9e6a03; padding: 15px; border-radius: 8px; flex: 1;">
                <strong>[03] Execution</strong><br><span style="font-size: 11px; color: #8b949e;">Variant & Proteomics</span><br>ðŸŸ¡ PROCESSING
            </div>
            <div style="color: #8b949e; font-size: 20px;">âž”</div>
            <div style="background: #1f6feb; padding: 15px; border-radius: 8px; flex: 1;">
                <strong>[04] Dissemination</strong><br><span style="font-size: 11px; color: #8b949e;">Audit & PDF Report</span><br>ðŸŸ¢ READY
            </div>
        </div>
    </div>
    """
    ...
    with col_icu2:
        st.markdown("**Thermal Cycler & PCR Chamber Temperatures (Â°C)**")
