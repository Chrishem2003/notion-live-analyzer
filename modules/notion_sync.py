...
class NotionSyncEngine:
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Page Property Update Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Sync Cleaned Data Column Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
def render_notion_sync_ui(df: pd.DataFrame):
    ...
    st.markdown("### Ã°Å¸â€â€ž Notion Bi-Directional Sync")
    ...
    if not has_page_ids:
        st.info(
            "Ã°Å¸â€™Â¡ **Bi-directional sync requires data sourced from Notion.** "
    ...
    tab1, tab2, tab3 = st.tabs(["Ã°Å¸â€œÂ¤ Push Insights", "Ã°Å¸â€œÂ Push Cleaned Data", "ðŸ“‹ Sync History"])

    with tab1:
        st.subheader("Ã°Å¸â€œÂ¤ Push AI Insights to Notion")
        ...
        if insights:
            ...
            if st.button("Ã°Å¸Å¡â‚¬ Push Insight to Notion Pages", type="primary"):
    ...
    with tab2:
        st.subheader("Ã°Å¸â€œÂ Push Cleaned/Transformed Data")
        ...
        # Quick actions
        st.markdown("#### Ã¢Å¡Â¡ Quick Actions")
        ...
        with col2:
            if st.button("Ã°Å¸ÂÂ·Ã¯Â¸Â Sync Tags/Notes", use_container_width=True):
