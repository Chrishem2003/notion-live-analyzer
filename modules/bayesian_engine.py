...
def render_bayesian_analysis_ui():
    ...
    with tab1:
        ...
        if st.button("ðŸ§ª Compute Bayes Factor", type="primary", use_container_width=True):
    ...
    with tab3:
        ...
        if st.button("ðŸ“ Compute Bayes Factor", type="primary", use_container_width=True):
