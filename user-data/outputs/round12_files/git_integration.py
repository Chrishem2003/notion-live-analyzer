...
def render_git_integration_ui():
    ...
    if not engine.connected:
        ...
        with st.form("git_connect_form"):
            ...
            submitted = st.form_submit_button("ðŸ”— Connect to GitHub", type="primary", width='stretch')
    ...
    with col1:
        if st.button("ðŸ”„ Refresh Connection", width='stretch'):
            st.rerun()
    with col2:
    ...
    with col3:
        if st.button("ðŸ”Œ Disconnect", width='stretch', type="secondary"):
            engine.disconnect()
    ...
    with tab2:
        ...
        if files:
            ...
            if data_files:
                ...
                if st.button("ðŸ“¥ Pull & Load Dataset", type="primary", width='stretch'):
                    ...
                    if pulled_df is not None:
                        ...
                        st.dataframe(pulled_df.head(20), width='stretch', hide_index=True)
            else:
    ...
    with tab3:
        ...
        if active_df is not None and not active_df.empty:
            ...
            col1, col2 = st.columns(2)
            with col1:
                if st.button("ðŸ“¤ Push Cleaned Dataset (CSV)", width='stretch'):
            ...
            with col2:
                if st.button("ðŸ“¤ Push Analysis Script", width='stretch'):
        ...
        if st.button("ðŸ“¤ Push Named Dataset", width='stretch'):
