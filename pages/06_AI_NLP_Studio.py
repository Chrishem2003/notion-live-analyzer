...
"""
    ...
    st.download_button("⬇️ Download Enterprise Markdown Report", data=report, file_name="executive_intelligence_report.md", mime="text/markdown", width='stretch')
...
def main():
    ...
    hero_card(
        ...
        badge_text="AI & NLP STUDIO • PREMIUM TIER",
    )
