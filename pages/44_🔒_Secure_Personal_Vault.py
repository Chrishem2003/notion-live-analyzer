"""
🔒 World-Class Secure Personal Vault & Enterprise Cloud Workspace Suite (Master Build)
...
# Modern Google Workspace & GCP Console Styling
...
if active_mod == "📁 Drive & Cloud Storage Engine":
    ...
    with m1:
        st.markdown(f"""<div class="metric-box"><div class="metric-box-title">Encryption</div><div class="metric-box-value">{crypto_algo.split()[0]}</div></div>""", unsafe_allow_html=True)
    with m2:
        st.markdown(f"""<div class="metric-box"><div class="metric-box-title">KMS Engine</div><div class="metric-box-value">GCP HSM</div></div>""", unsafe_allow_html=True)
    with m3:
        st.markdown("""<div class="metric-box"><div class="metric-box-title">Capacity Mode</div><div class="metric-box-value">Multi-Cloud ♾️</div></div>""", unsafe_allow_html=True)
    with m4:
        st.markdown("""<div class="metric-box"><div class="metric-box-title">DLP Status</div><div class="metric-box-value">Active (0 Leak)</div></div>""", unsafe_allow_html=True)
