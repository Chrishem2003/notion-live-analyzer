...
class _Config:
    ...
    def conf_features_partial(self):
        ...
        if self.cc_on_aarch64 and is_unix: return dict(
            ...
            ASIMDHP = dict(
                flags="-march=armv8.2-afp16"
            ),
            ASIMDDP = dict(
                flags="-march=armv8.2-adotprod"
            ),
            ASIMDFHM = dict(
                flags="-march=armv8.2-afp16fml"
            ),
        )
        if self.cc_on_armhf and is_unix: return dict(
            ...
            ASIMD = dict(
                flags="-mfpu=neon-fp-armv8 -march=armv8-asimd",
            ),
            ASIMDHP = dict(
                flags="-march=armv8.2-afp16"
            ),
...
class _CCompiler:
    ...
    def cc_normalize_flags(self, flags):
        ...
        Examples
        --------
        >>> self.cc_normalize_flags(['-march=armv8.2-afp16', '-march=armv8.2-adotprod'])
        ['armv8.2-afp16dotprod']
