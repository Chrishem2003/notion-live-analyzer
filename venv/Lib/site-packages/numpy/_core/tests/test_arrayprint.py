...
class TestComplexArray:
    def test_str(self):
        ...
        wanted = [
            ...
            '[-1.-infj]',  '[-1.-infj]',  '[-1.-infj]',
            '[-1.nanj]',  '[-1.nanj]',  '[-1.nanj]',
            '[inf0.j]',   '[inf0.j]',   '[inf0.j]',
            '[inf1.j]',   '[inf1.j]',   '[inf1.j]',
            '[inf-1.j]',   '[inf-1.j]',   '[inf-1.j]',
            '[infinfj]',  '[infinfj]',  '[infinfj]',
            '[inf-infj]',  '[inf-infj]',  '[inf-infj]',
            '[infnanj]',  '[infnanj]',  '[infnanj]',
            '[-inf0.j]',  '[-inf0.j]',  '[-inf0.j]',
            '[-inf1.j]',  '[-inf1.j]',  '[-inf1.j]',
            '[-inf-1.j]',  '[-inf-1.j]',  '[-inf-1.j]',
            '[-infinfj]', '[-infinfj]', '[-infinfj]',
            '[-inf-infj]', '[-inf-infj]', '[-inf-infj]',
            '[-infnanj]', '[-infnanj]', '[-infnanj]',
            '[nan0.j]',   '[nan0.j]',   '[nan0.j]',
            '[nan1.j]',   '[nan1.j]',   '[nan1.j]',
            '[nan-1.j]',   '[nan-1.j]',   '[nan-1.j]',
            '[naninfj]',  '[naninfj]',  '[naninfj]',
...
class TestPrintOptions:
    ...
    def test_0d_arrays(self):
        ...
        assert_equal(repr(np.array('caf̩', '<U4')),
                     "array('caf̩', dtype='<U4')")
    ...
    def test_float_spacing(self):
        ...
        assert_equal(repr(x), 'array([     inf, 1.00e05, 1.12e00])')
        assert_equal(repr(y), 'array([      inf,  1.00e05, -1.12e00])')
        assert_equal(repr(z), 'array([       inf,  1.12e000, -1.00e120])')
    ...
    def test_sign_spacing(self):
        ...
        assert_equal(repr(b), 'array([1.234e09])')
        assert_equal(repr(np.array([0.])), 'array([0.])')
        assert_equal(repr(c),
            "array([1.        1.j        , 1.123456791.12345679j])")
        ...
        np.set_printoptions(legacy='1.13')
        assert_equal(repr(a), 'array([ 0.,  1.,  2.,  3.])')
        assert_equal(repr(b),  'array([  1.23400000e09])')
        assert_equal(repr(-b), 'array([ -1.23400000e09])')
        assert_equal(repr(np.array(1.)), 'array(1.0)')
        assert_equal(repr(np.array([0.])), 'array([ 0.])')
        assert_equal(repr(c),
            "array([ 1.000000001.j        ,  1.123456791.12345679j])")
        # gh-10383
    ...
    def test_floatmode(self):
        ...
        assert_equal(repr(w),
            "array([1.e00, 1.e01, 1.e02, 1.e03, 1.e04, 1.e05, 1.e06, 1.e07,\n"
            "       1.e08, 1.e09, 1.e10, 1.e11, 1.e12, 1.e13, 1.e14, 1.e15,\n"
            "       1.e16, 1.e17, 1.e18, 1.e19, 1.e20, 1.e21, 1.e22, 1.e23,\n"
            "       1.e24])")
        assert_equal(repr(wp), "array([1.234e001, 1.000e002, 1.000e123])")
        assert_equal(repr(c),
            "array([1.         1.j         , 1.1234567891.123456789j])")
        ...
        assert_equal(repr(w[::5]),
            "array([1.e00, 1.e05, 1.e10, 1.e15, 1.e20])")
        assert_equal(repr(wp), "array([1.234e001, 1.000e002, 1.000e123])")
        assert_equal(repr(c),
            "array([1.        1.j        , 1.123456791.12345679j])")
        ...
        assert_equal(repr(w[::5]),
            "array([1.0000e00, 1.0000e05, 1.0000e10, 1.0000e15, 1.0000e20])")
        assert_equal(repr(wp), "array([1.2340e001, 1.0000e002, 1.0000e123])")
        assert_equal(repr(np.zeros(3)), "array([0.0000, 0.0000, 0.0000])")
        assert_equal(repr(c),
            "array([1.00001.0000j, 1.12351.1235j])")
        ...
        assert_equal(repr(wp), "array([1.234e001, 1.000e002, 1.000e123])")
        assert_equal(repr(c),
            "array([1.000000001.00000000j, 1.123456791.12345679j])")
    ...
    test_cases_gh_28679 = [
        ...
        (np.half([999, 1000]), "[9.99e02 1.00e03]"),
        (np.single([999999, 999999]), "[999999. 999999.]"),
        (np.single([999999, -1000000]), "[ 9.99999e05 -1.00000e06]"),
        (
        ...
        (
            ...
            "[999999.9.99999e05j 999999.-1.00000e06j]"
        ),
    ]
    ...
    test_cases_legacy_2_2 = [
        ...
        (np.single([1.e7, 1.e8]), "[1.e07 1.e08]"),
    ]
    ...
    def test_legacy_mode_scalars(self):
        ...
        assert_equal(str(np.complex128(complex(1, np.nan))), '(1nan*j)')

        np.set_printoptions(legacy=False)
        assert_equal(str(np.float64(1.123456789123456789)),
                     '1.1234567891234568')
        assert_equal(str(np.complex128(complex(1, np.nan))), '(1nanj)')
