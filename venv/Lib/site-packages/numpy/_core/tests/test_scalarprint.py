...
class TestRealScalars:
    ...
    def test_dragon4(self):
        ...
        assert_equal(fsci32('1.0'), "1.e00")
        assert_equal(fpos32('10.234'), "10.234")
        assert_equal(fpos32('-10.234'), "-10.234")
        assert_equal(fsci32('10.234'), "1.0234e01")
        assert_equal(fsci32('-10.234'), "-1.0234e01")
        assert_equal(fpos32('1000.0'), "1000.")
        assert_equal(fpos32('1.0', precision=0), "1.")
        assert_equal(fsci32('1.0', precision=0), "1.e00")
        assert_equal(fpos32('10.234', precision=0), "10.")
        assert_equal(fpos32('-10.234', precision=0), "-10.")
        assert_equal(fsci32('10.234', precision=0), "1.e01")
        assert_equal(fsci32('-10.234', precision=0), "-1.e01")
        assert_equal(fpos32('10.234', precision=2), "10.23")
        assert_equal(fsci32('-10.234', precision=2), "-1.02e01")
        ...
        assert_equal(fsci32('299792458.0', **preckwd(5)), "2.99792e08")
        assert_equal(fpos64('299792458.0', **preckwd(5)), "299792458.00000")
        assert_equal(fsci64('299792458.0', **preckwd(5)), "2.99792e08")
        ...
        assert_equal(fsci64('1e120', min_digits=3), '1.000e120')
        assert_equal(fsci64('1e100', min_digits=3), '1.000e100')

        # test trailing zeros
        assert_equal(fpos32('1.0', unique=False, precision=3), "1.000")
        assert_equal(fpos64('1.0', unique=False, precision=3), "1.000")
        assert_equal(fsci32('1.0', unique=False, precision=3), "1.000e00")
        assert_equal(fsci64('1.0', unique=False, precision=3), "1.000e00")
        assert_equal(fpos32('1.5', unique=False, precision=3), "1.500")
        assert_equal(fpos64('1.5', unique=False, precision=3), "1.500")
        assert_equal(fsci32('1.5', unique=False, precision=3), "1.500e00")
        assert_equal(fsci64('1.5', unique=False, precision=3), "1.500e00")
        # gh-10713
    ...
    def test_dragon4_scientific_interface(self, tp):
        ...
        # test exp_digits
        assert_equal(fsci(tp('1.23e1'), exp_digits=5), "1.23e00001")
