...
def test_complex_inf_nan(dtype):
    ...
    TESTS = {
        complex(np.inf, 0): "(inf0j)",
        complex(0, np.inf): "infj",
        complex(-np.inf, 0): "(-inf0j)",
        complex(0, -np.inf): "-infj",
        complex(np.inf, 1): "(inf1j)",
        complex(1, np.inf): "(1infj)",
        complex(-np.inf, 1): "(-inf1j)",
        complex(1, -np.inf): "(1-infj)",
        complex(np.nan, 0): "(nan0j)",
        complex(0, np.nan): "nanj",
        complex(-np.nan, 0): "(nan0j)",
        complex(0, -np.nan): "nanj",
        complex(np.nan, 1): "(nan1j)",
        complex(1, np.nan): "(1nanj)",
        complex(-np.nan, 1): "(nan1j)",
        complex(1, -np.nan): "(1nanj)",
    }
...
def test_complex_type_print(tp):
    ...
    _test_redirected_print(complex(np.inf, 1), tp, '(inf1j)')
    _test_redirected_print(complex(-np.inf, 1), tp, '(-inf1j)')
    _test_redirected_print(complex(-np.nan, 1), tp, '(nan1j)')
