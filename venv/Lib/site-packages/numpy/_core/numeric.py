...
def correlate(a, v, mode='valid'):
    ...
    .. math:: c_k = \sum_n a_{nk} \cdot \overline{v}_n
    ...
    .. math:: c'_k = \sum_n a_{n} \cdot \overline{v_{nk}}
    ...
    >>> np.correlate([11j, 2, 3-1j], [0, 1, 0.5j], 'full')
    array([ 0.5-0.5j,  1.00.j ,  1.5-1.5j,  3.0-1.j ,  0.00.j ])

    Note that you get the time reversed, complex conjugated result
    (:math:`\overline{c_{-k}}`) when the two input sequences a and v change
    places:

    >>> np.correlate([0, 1, 0.5j], [11j, 2, 3-1j], 'full')
    array([ 0.00.j ,  3.01.j ,  1.51.5j,  1.00.j ,  0.50.5j])
...
def convolve(a, v, mode='full'):
    ...
    mode : {'full', 'valid', 'same'}, optional
        'full':
          ...
          at each point of overlap, with an output shape of (NM-1,). At
...
def rollaxis(a, axis, start=0):
    ...
    start : int, optional
        ...
        .. |vdots|   unicode:: U22EE .. Vertical Ellipsis
