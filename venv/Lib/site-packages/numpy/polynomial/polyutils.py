...
def trimcoef(c, tol=0):
    ...
    >>> pu.trimcoef((3e-4,1e-3*(1-i),5e-4,2e-5*(1i)), 1e-3)
    array([0.00030.j   , 0.001 -0.001j])
...
def mapdomain(x, old, new):
    ...
    array([-1. -1.j , -0.6-0.6j, -0.2-0.2j,  0.20.2j,  0.60.6j,  1. 1.j ])
    >>> new_z = pu.mapdomain(z, old, new); new_z
    array([-1.01.j , -0.60.6j, -0.20.2j,  0.2-0.2j,  0.6-0.6j,  1.0-1.j ]) # may vary
