...
class TestStrUnicodeSuperSubscripts:
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0  1.0Â·x  2.0Â·xÂ²  3.0Â·xÂ³  4.0Â·xâ´  5.0Â·xâµ  "
...
def test_complex_coefficients():
    ...
    poly.set_default_printstyle('unicode')
    assert_equal(str(p1), "1j  (11j)Â·x - (2-2j)Â·xÂ²  (30j)Â·xÂ³")
    assert_equal(str(p2), "1j  (11j)Â·x  (-22j)Â·xÂ²  (30j)Â·xÂ³")
    poly.set_default_printstyle('ascii')
    assert_equal(str(p1), "1j  (11j) x - (2-2j) x**2  (30j) x**3")
    assert_equal(str(p2), "1j  (11j) x  (-22j) x**2  (30j) x**3")
...
class TestPrintOptions:
    ...
    def test_latex(self):
        ...
        assert_equal(p._repr_latex_(),
            ...
            r'\text{(1.42857143e08)}\,x^{3}$')

        with printoptions(precision=3):
            assert_equal(p._repr_latex_(),
                r'$x \mapsto \text{0.5}  \text{0.143}\,x  '
                r'\text{14285714.286}\,x^{2}  \text{(1.429e08)}\,x^{3}$')
