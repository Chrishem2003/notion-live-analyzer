...
def inv(a):
    ...
    array([[-1.12589991e15, -5.62949953e14,  5.62949953e14],
       [-1.12589991e15, -5.62949953e14,  5.62949953e14],
       [ 1.12589991e15,  5.62949953e14, -5.62949953e14]])
    >>> a @ inv(a)
    ...
    >>> cond(a)
    np.float64(8.659885634118668e17)  # may vary
...
def eig(a):
    ...
    array([1.1.j, 1.-1.j])
    >>> eigenvectors
    array([[0.707106780.j        , 0.70710678-0.j        ],
    ...
    array([2.0.j, 0.0.j])
    >>> eigenvectors
    array([[ 0.        0.70710678j,  0.707106780.j        ], # may vary
           [ 0.707106780.j        , -0.        0.70710678j]])
...
def eigh(a, UPLO='L'):
    ...
    >>> eigenvectors
    array([[-0.923879530.j        , -0.382683430.j        ], # may vary
           [ 0.        0.38268343j,  0.        -0.92387953j]])

    >>> (np.dot(a, eigenvectors[:, 0]) -
    ... eigenvalues[0] * eigenvectors[:, 0])  # verify 1st eigenval/vec pair
    array([5.55111512e-170.0000000e00j, 0.00000000e001.2490009e-16j])
    ...
    array([0.17157288, 5.82842712])
    >>> eigenvectors
    matrix([[-0.923879530.j        , -0.382683430.j        ], # may vary
            [ 0.        0.38268343j,  0.        -0.92387953j]])
    ...
    array([6.0.j, 1.0.j])
    >>> va
    array([[-0.4472136 0.j        , -0.894427190.j        ], # may vary
           [ 0.        0.89442719j,  0.        -0.4472136j ]])
    >>> vb
    array([[ 0.894427190.j       , -0.        0.4472136j],
           [-0.        0.4472136j,  0.894427190.j       ]])
...
def svdvals(x, /):
    ...
    ...                        [2, 4, 6],
    ...                        [-1, 1, -1]]); s
    array([8.38434191e00, 1.64402274e00, 2.31534378e-16])
