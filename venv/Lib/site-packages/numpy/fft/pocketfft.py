...
def fft(a, n=None, axis=-1, norm=None, out=None):
    ...
    array([-2.33486982e-161.14423775e-17j,  8.00000000e00-1.25557246e-15j,
            2.33486982e-162.33486982e-16j,  0.00000000e001.22464680e-16j,
           -1.14423775e-172.33486982e-16j,  0.00000000e005.20784380e-16j,
            1.14423775e-171.14423775e-17j,  0.00000000e001.22464680e-16j])
...
def rfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    out : complex ndarray
        ...
        If `n` is odd, the length is ``(n1)/2``.
...
def irfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    n : int, optional
        Length of the transformed axis of the output.
        For `n` output points, ``n//21`` input points are necessary.  If the
...
def rfftn(a, s=None, axes=None, norm=None, out=None):
    ...
    out : complex ndarray
        ...
        indicated by `axes`, or by a combination of `s` and `a`,
        as explained in the parameters section above.
        The length of the last axis transformed will be ``s[-1]//21``,
...
def irfftn(a, s=None, axes=None, norm=None, out=None):
    ...
    s : sequence of ints, optional
        ...
        where ``s[-1]//21`` points of the input are used.
