...
def iscomplex(x):
    ...
    --------
    >>> import numpy as np
    >>> np.iscomplex([11j, 10j, 4.5, 3, 2, 2j])
...
def isreal(x):
    ...
    --------
    >>> import numpy as np
    >>> a = np.array([11j, 10j, 4.5, 3, 2, 2j], dtype=complex)
    >>> np.isreal(a)
    ...
    >>> a = np.array([1, "2", 34j], dtype=object)
    >>> np.isreal(a)
    array([ True,  True,  True])

    isreal should not be used with object arrays

    >>> a = np.array([12j, 21j], dtype=object)
    >>> np.isreal(a)
    array([ True,  True])
...
def nan_to_num(x, copy=True, nan=0.0, posinf=None, neginf=None):
    ...
    >>> np.nan_to_num(x)
    array([ 1.79769313e308, -1.79769313e308,  0.00000000e000, # may vary
           -1.28000000e002,  1.28000000e002])
    >>> np.nan_to_num(x, nan=-9999, posinf=33333333, neginf=33333333)
    array([ 3.3333333e07,  3.3333333e07, -9.9990000e03,
           -1.2800000e02,  1.2800000e02])
    ...
    array([ 3.3333333e07,  3.3333333e07, -9.9990000e03, -1.2800000e02,
            1.2800000e02])
    >>> y = np.array([complex(np.inf, np.nan), np.nan, complex(np.nan, np.inf)])
    array([  1.79769313e308,  -1.79769313e308,   0.00000000e000, # may vary
         -1.28000000e002,   1.28000000e002])
    >>> np.nan_to_num(y)
    array([  1.79769313e308 0.00000000e000j, # may vary
             0.00000000e000 0.00000000e000j,
             0.00000000e000 1.79769313e308j])
