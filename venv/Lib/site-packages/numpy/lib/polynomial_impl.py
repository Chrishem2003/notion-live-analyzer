...
def roots(p):
    ...
    If the length of `p` is n1 then the polynomial is described by::
    ...
    >>> coeff = [3.2, 2, 1]
    >>> np.roots(coeff)
    array([-0.31250.46351241j, -0.3125-0.46351241j])
...
class poly1d:
    ...
    >>> p(p.r)
    array([ -4.44089210e-160.j,  -4.44089210e-160.j]) # may vary
