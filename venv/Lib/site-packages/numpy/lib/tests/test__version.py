...
def test_dev0_version():
    assert_(NumpyVersion('1.9.0.dev0Unknown') < '1.9.0')
    for ver in ['1.9.0', '1.9.0a1', '1.9.0b2', '1.9.0b2.dev0ffffffff']:
        assert_(NumpyVersion('1.9.0.dev0f16acvda') < ver)

    assert_(NumpyVersion('1.9.0.dev0f16acvda') == '1.9.0.dev011111111')


def test_dev0_a_b_rc_mixed():
    assert_(NumpyVersion('1.9.0a2.dev0f16acvda') == '1.9.0a2.dev011111111')
    assert_(NumpyVersion('1.9.0a2.dev06acvda54') < '1.9.0a2')
