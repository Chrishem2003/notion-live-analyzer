...
class TestSaveTxt:
    ...
    def test_complex_arrays(self):
        ...
        assert_equal(
            lines,
            [b' ( 3.142e00 2.718e00j)  ( 3.142e00 2.718e00j)\n',
             b' ( 3.142e00 2.718e00j)  ( 3.142e00 2.718e00j)\n'])
        ...
        assert_equal(
            lines,
            [b'  3.142e00  2.718e00  3.142e00  2.718e00\n',
             b'  3.142e00  2.718e00  3.142e00  2.718e00\n'])
        ...
        assert_equal(
            lines,
            [b'(3.142e002.718e00j) (3.142e002.718e00j)\n',
             b'(3.142e002.718e00j) (3.142e002.718e00j)\n'])
...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_complex_misformatted(self):
        ...
        txt_bad = txt.replace(b'e00-', b'e00-')
        assert_(txt_bad != txt)
        c.write(txt_bad)
        c.seek(0)
        res = np.loadtxt(c, dtype=complex)
...
class TestFromTxt(LoadTxtBase):
    ...
    def test_auto_dtype(self):
        ...
        data = TextIO('A 64 75.0 34j True\nBCD 25 60.0 56j False')
        with warnings.catch_warnings(record=True) as w:
            warnings.filterwarnings('always', '', VisibleDeprecationWarning)
