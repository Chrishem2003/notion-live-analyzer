...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    .. math::
        ...
        \\hat f_{i}^{(1)}=
            \\frac{f\\left(x_{i1}\\right) - f\\left(x_{i-1}\\right)}{2h}
...
def diff(a, n=1, axis=-1, prepend=np._NoValue, append=np._NoValue):
    ...
    The first difference is given by ``out[i] = a[i1] - a[i]`` along
...
def angle(z, deg=False):
    ...
    --------
    >>> import numpy as np
    >>> np.angle([1.0, 1.0j, 11j])               # in radians
    array([ 0.        ,  1.57079633,  0.78539816]) # may vary
    >>> np.angle(11j, deg=True)                  # in degrees
    45.0
...
class vectorize:
    ...
    >>> import numpy as np
    >>> def myfunc(a, b):
    ...     "Return a-b if a>b, otherwise return ab"
    ...     if a > b:
    ...         return a - b
    ...     else:
    ...         return a  b
...
def sinc(x):
    ...
    >>> np.sinc(x)
     array([-3.89804309e-17,  -4.92362781e-02,  -8.40918587e-02, # may vary
            ...
            7.56826729e-01,   9.35489284e-01,   1.00000000e00,
