...
def _ensure_api_header(response: Response) -> None:
    ...
    if content_type_l.startswith(
        (
            "text/html",
            "application/vnd.pypi.simple.v1html",
            "application/vnd.pypi.simple.v1json",
        )
    ):
        return
...
def _get_simple_response(
    ...
    headers = {
        "Accept": ", ".join(
            [
                "application/vnd.pypi.simple.v1json",
                "application/vnd.pypi.simple.v1html; q=0.1",
                "text/html; q=0.01",
            ]
        ),
    }
...
def parse_links(page: IndexContent) -> Iterable[Link]:
    ...
    if content_type_l.startswith("application/vnd.pypi.simple.v1json"):
...
def _get_index_content(
    ...
    *,
    ...
    if url.startswith("file:") and os.path.isdir(url_to_path(url)):
        ...
        #       standard file extension for application/vnd.pypi.simple.v1json
    ...
    try:
        ...
        logger.warning(
            ...
            "The only supported Content-Types are application/vnd.pypi.simple.v1json, "
            "application/vnd.pypi.simple.v1html, and text/html",
            link,
            exc.request_desc,
            exc.content_type,
        )
