...
class Subversion(VersionControl):
    ...
    dirname = ".svn"
    repo_name = "checkout"
    schemes = ("svnssh", "svnhttp", "svnhttps", "svnsvn", "svnfile")
    ...
    def get_netloc_and_auth(
        ...
        if scheme == "ssh":
            ...
            # svnssh URLs, so keep the auth information in the URL.
    ...
    def get_url_rev_and_auth(cls, url: str) -> tuple[str, str | None, AuthInfo]:
        # hotfix the URL scheme after removing svn from svnssh:// re-add it
