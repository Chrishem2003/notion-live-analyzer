...
class Version(_BaseVersion):
    ...
    def __setstate__(self, state: object) -> None:
        # Always discard cached values â€” they may contain stale references
    ...
    def public(self) -> str:
        ...
        '1.2.3'
        >>> Version("1.2.3abc").public
        '1.2.3'
        >>> Version("1!1.2.3dev1abc").public
        '1!1.2.3.dev1'
        """
    ...
    def base_version(self) -> str:
        ...
        '1.2.3'
        >>> Version("1.2.3abc").base_version
        '1.2.3'
        >>> Version("1!1.2.3dev1abc").base_version
        '1!1.2.3'
