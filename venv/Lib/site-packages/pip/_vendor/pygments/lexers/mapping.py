...
LEXERS = {
    ...
    'Angular2HtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML  Angular2', ('htmlng2',), ('*.ng2',), ()),
    ...
    'CSSUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'CSSUL4', ('cssul4',), ('*.cssul4',), ()),
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLCheetah', ('htmlcheetah', 'htmlspitfire', 'htmlcheetah'), (), ('text/htmlcheetah', 'text/htmlspitfire')),
    'CheetahJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptCheetah', ('javascriptcheetah', 'jscheetah', 'javascriptspitfire', 'jsspitfire'), (), ('application/x-javascriptcheetah', 'text/x-javascriptcheetah', 'text/javascriptcheetah', 'application/x-javascriptspitfire', 'text/x-javascriptspitfire', 'text/javascriptspitfire')),
    ...
    'CheetahXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XMLCheetah', ('xmlcheetah', 'xmlspitfire'), (), ('application/xmlcheetah', 'application/xmlspitfire')),
    ...
    'CppLexer': ('pip._vendor.pygments.lexers.c_cpp', 'C', ('cpp', 'c'), ('*.cpp', '*.hpp', '*.c', '*.h', '*.cc', '*.hh', '*.cxx', '*.hxx', '*.C', '*.H', '*.cp', '*.CPP', '*.tpp', '*.cppm', '*.ixx', '*.mxx'), ('text/x-chdr', 'text/x-csrc')),
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'CSSDjango/Jinja', ('cssdjango', 'cssjinja'), ('*.css.j2', '*.css.jinja2'), ('text/cssdjango', 'text/cssjinja')),
    'CssErbLexer': ('pip._vendor.pygments.lexers.templates', 'CSSRuby', ('cssruby', 'csserb'), (), ('text/cssruby',)),
    'CssGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'CSSGenshi Text', ('cssgenshitext', 'cssgenshi'), (), ('text/cssgenshi',)),
    'CssLexer': ('pip._vendor.pygments.lexers.css', 'CSS', ('css',), ('*.css',), ('text/css',)),
    'CssPhpLexer': ('pip._vendor.pygments.lexers.templates', 'CSSPHP', ('cssphp',), (), ('text/cssphp',)),
    'CssSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'CSSSmarty', ('csssmarty',), (), ('text/csssmarty',)),
    ...
    'DuelLexer': ('pip._vendor.pygments.lexers.webmisc', 'Duel', ('duel', 'jbst', 'jsonmlbst'), ('*.duel', '*.jbst'), ('text/x-duel', 'text/x-jbst')),
    ...
    'EvoqueHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLEvoque', ('htmlevoque',), (), ('text/htmlevoque',)),
    'EvoqueLexer': ('pip._vendor.pygments.lexers.templates', 'Evoque', ('evoque',), ('*.evoque',), ('application/x-evoque',)),
    'EvoqueXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XMLEvoque', ('xmlevoque',), (), ('application/xmlevoque',)),
    ...
    'FennelLexer': ('pip._vendor.pygments.lexers.lisp', 'Fennel', ('fennel', 'fnl'), ('*.fnl', '*.fnlm'), ('text/x-fennel',)),
    ...
    'GenshiLexer': ('pip._vendor.pygments.lexers.templates', 'Genshi', ('genshi', 'kid', 'xmlgenshi', 'xmlkid'), ('*.kid',), ('application/x-genshi', 'application/x-kid')),
    ...
    'HTMLUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'HTMLUL4', ('htmlul4',), ('*.htmlul4',), ()),
    'HamlLexer': ('pip._vendor.pygments.lexers.html', 'Haml', ('haml',), ('*.haml',), ('text/x-haml',)),
    'HandlebarsHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLHandlebars', ('htmlhandlebars',), ('*.handlebars', '*.hbs'), ('text/htmlhandlebars', 'text/x-handlebars-template')),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLDjango/Jinja', ('htmldjango', 'htmljinja', 'htmldjango'), ('*.html.j2', '*.htm.j2', '*.xhtml.j2', '*.html.jinja2', '*.htm.jinja2', '*.xhtml.jinja2'), ('text/htmldjango', 'text/htmljinja')),
    'HtmlGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLGenshi', ('htmlgenshi', 'htmlkid'), (), ('text/htmlgenshi',)),
    'HtmlLexer': ('pip._vendor.pygments.lexers.html', 'HTML', ('html',), ('*.html', '*.htm', '*.xhtml', '*.xslt'), ('text/html', 'application/xhtmlxml')),
    'HtmlPhpLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLPHP', ('htmlphp',), ('*.phtml',), ('application/x-php', 'application/x-httpd-php', 'application/x-httpd-php3', 'application/x-httpd-php4', 'application/x-httpd-php5')),
    'HtmlSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLSmarty', ('htmlsmarty',), (), ('text/htmlsmarty',)),
    ...
    'JavascriptDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptDjango/Jinja', ('javascriptdjango', 'jsdjango', 'javascriptjinja', 'jsjinja'), ('*.js.j2', '*.js.jinja2'), ('application/x-javascriptdjango', 'application/x-javascriptjinja', 'text/x-javascriptdjango', 'text/x-javascriptjinja', 'text/javascriptdjango', 'text/javascriptjinja')),
    'JavascriptErbLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptRuby', ('javascriptruby', 'jsruby', 'javascripterb', 'jserb'), (), ('application/x-javascriptruby', 'text/x-javascriptruby', 'text/javascriptruby')),
    'JavascriptGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptGenshi Text', ('jsgenshitext', 'jsgenshi', 'javascriptgenshitext', 'javascriptgenshi'), (), ('application/x-javascriptgenshi', 'text/x-javascriptgenshi', 'text/javascriptgenshi')),
    ...
    'JavascriptPhpLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptPHP', ('javascriptphp', 'jsphp'), (), ('application/x-javascriptphp', 'text/x-javascriptphp', 'text/javascriptphp')),
    'JavascriptSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptSmarty', ('javascriptsmarty', 'jssmarty'), (), ('application/x-javascriptsmarty', 'text/x-javascriptsmarty', 'text/javascriptsmarty')),
    'JavascriptUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'JavascriptUL4', ('jsul4',), ('*.jsul4',), ()),
    ...
    'JsonLdLexer': ('pip._vendor.pygments.lexers.data', 'JSON-LD', ('jsonld', 'json-ld'), ('*.jsonld',), ('application/ldjson',)),
    'JsonLexer': ('pip._vendor.pygments.lexers.data', 'JSON', ('json', 'json-object'), ('*.json', '*.jsonl', '*.ndjson', 'Pipfile.lock', '*.module', '*.xc'), ('application/json', 'application/json-object', 'application/x-ndjson', 'application/jsonl', 'application/json-seq')),
    ...
    'LassoCssLexer': ('pip._vendor.pygments.lexers.templates', 'CSSLasso', ('csslasso',), (), ('text/csslasso',)),
    'LassoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLLasso', ('htmllasso',), (), ('text/htmllasso', 'application/x-httpd-lasso', 'application/x-httpd-lasso[89]')),
    'LassoJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptLasso', ('javascriptlasso', 'jslasso'), (), ('application/x-javascriptlasso', 'text/x-javascriptlasso', 'text/javascriptlasso')),
    'LassoLexer': ('pip._vendor.pygments.lexers.javascript', 'Lasso', ('lasso', 'lassoscript'), ('*.lasso', '*.lasso[89]'), ('text/x-lasso',)),
    'LassoXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XMLLasso', ('xmllasso',), (), ('application/xmllasso',)),
    ...
    'MakoCssLexer': ('pip._vendor.pygments.lexers.templates', 'CSSMako', ('cssmako',), (), ('text/cssmako',)),
    'MakoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLMako', ('htmlmako',), (), ('text/htmlmako',)),
    'MakoJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptMako', ('javascriptmako', 'jsmako'), (), ('application/x-javascriptmako', 'text/x-javascriptmako', 'text/javascriptmako')),
    'MakoLexer': ('pip._vendor.pygments.lexers.templates', 'Mako', ('mako',), ('*.mao',), ('application/x-mako',)),
    'MakoXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XMLMako', ('xmlmako',), (), ('application/xmlmako',)),
    ...
    'MathematicaLexer': ('pip._vendor.pygments.lexers.algebra', 'Mathematica', ('mathematica', 'mma', 'nb', 'wl', 'wolfram'), ('*.nb', '*.cdf', '*.nbp', '*.ma', '*.wl', '*.wls'), ('application/mathematica', 'application/vnd.wolfram.mathematica', 'application/vnd.wolfram.mathematica.package', 'application/vnd.wolfram.cdf', 'application/vnd.wolfram.wl')),
    ...
    'MesonLexer': ('pip._vendor.pygments.lexers.meson', 'Meson', ('meson', 'meson.build'), ('meson.build', 'meson.options', 'meson_options.txt'), ('text/x-meson',)),
    ...
    'MozPreprocCssLexer': ('pip._vendor.pygments.lexers.markup', 'CSSmozpreproc', ('cssmozpreproc',), ('*.css.in',), ()),
    'MozPreprocHashLexer': ('pip._vendor.pygments.lexers.markup', 'mozhashpreproc', ('mozhashpreproc',), (), ()),
    'MozPreprocJavascriptLexer': ('pip._vendor.pygments.lexers.markup', 'Javascriptmozpreproc', ('javascriptmozpreproc',), ('*.js.in',), ()),
    'MozPreprocPercentLexer': ('pip._vendor.pygments.lexers.markup', 'mozpercentpreproc', ('mozpercentpreproc',), (), ()),
    'MozPreprocXulLexer': ('pip._vendor.pygments.lexers.markup', 'XULmozpreproc', ('xulmozpreproc',), ('*.xul.in',), ()),
    ...
    'MyghtyCssLexer': ('pip._vendor.pygments.lexers.templates', 'CSSMyghty', ('cssmyghty',), (), ('text/cssmyghty',)),
    'MyghtyHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLMyghty', ('htmlmyghty',), (), ('text/htmlmyghty',)),
    'MyghtyJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScriptMyghty', ('javascriptmyghty', 'jsmyghty'), (), ('application/x-javascriptmyghty', 'text/x-javascriptmyghty', 'text/javascriptmygthy')),
    'MyghtyLexer': ('pip._vendor.pygments.lexers.templates', 'Myghty', ('myghty',), ('*.myt', 'autodelegate'), ('application/x-myghty',)),
    'MyghtyXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XMLMyghty', ('xmlmyghty',), (), ('application/xmlmyghty',)),
    ...
    'PythonLexer': ('pip._vendor.pygments.lexers.python', 'Python', ('python', 'py', 'sage', 'python3', 'py3', 'bazel', 'starlark', 'pyi'), ('*.py', '*.pyw', '*.pyi', '*.jy', '*.sage', '*.sc', 'SConstruct', 'SConscript', '*.bzl', 'BUCK', 'BUILD', 'BUILD.bazel', 'WORKSPACE', '*.tac', '*.pye'), ('text/x-python', 'application/x-python', 'text/x-python3', 'application/x-python3')),
    ...
    'PythonUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'PythonUL4', ('pyul4',), ('*.pyul4',), ()),
    ...
    'QmlLexer': ('pip._vendor.pygments.lexers.webmisc', 'QML', ('qml', 'qbs'), ('*.qml', '*.qbs'), ('application/x-qml', 'application/x-qt.qbsqml')),
    ...
    'RellLexer': ('pip._vendor.pygments.lexers.rell', 'Rell', ('rell',), ('*.rell',), ('text/x-rell',)),
    ...
    'RhtmlLexer': ('pip._vendor.pygments.lexers.templates', 'RHTML', ('rhtml', 'htmlerb', 'htmlruby'), ('*.rhtml',), ('text/htmlruby',)),
    ...
    'RocqLexer': ('pip._vendor.pygments.lexers.theorem', 'Rocq Prover', ('coq', 'rocq', 'rocq-prover'), ('*.v',), ('text/x-coq', 'text/x-rocq')),
    ...
    'SqlJinjaLexer': ('pip._vendor.pygments.lexers.templates', 'SQLJinja', ('sqljinja',), ('*.sql', '*.sql.j2', '*.sql.jinja2'), ()),
    ...
    'TwigHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLTwig', ('htmltwig',), ('*.twig',), ('text/htmltwig',)),
    ...
    'VelocityHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTMLVelocity', ('htmlvelocity',), (), ('text/htmlvelocity',)),
    'VelocityLexer': ('pip._vendor.pygments.lexers.templates', 'Velocity', ('velocity',), ('*.vm', '*.fhtml'), ()),
    'VelocityXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XMLVelocity', ('xmlvelocity',), (), ('application/xmlvelocity',)),
    ...
    'XMLUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'XMLUL4', ('xmlul4',), ('*.xmlul4',), ()),
    ...
    'XmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'XMLDjango/Jinja', ('xmldjango', 'xmljinja'), ('*.xml.j2', '*.xml.jinja2'), ('application/xmldjango', 'application/xmljinja')),
    'XmlErbLexer': ('pip._vendor.pygments.lexers.templates', 'XMLRuby', ('xmlruby', 'xmlerb'), (), ('application/xmlruby',)),
    'XmlLexer': ('pip._vendor.pygments.lexers.html', 'XML', ('xml',), ('*.xml', '*.xsl', '*.rss', '*.xslt', '*.xsd', '*.wsdl', '*.wsf', '*.xbrl', '*.pom'), ('text/xml', 'application/xml', 'image/svgxml', 'application/rssxml', 'application/atomxml')),
    'XmlPhpLexer': ('pip._vendor.pygments.lexers.templates', 'XMLPHP', ('xmlphp',), (), ('application/xmlphp',)),
    'XmlSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'XMLSmarty', ('xmlsmarty',), (), ('application/xmlsmarty',)),
    ...
    'XsltLexer': ('pip._vendor.pygments.lexers.html', 'XSLT', ('xslt',), ('*.xsl', '*.xslt', '*.xpl'), ('application/xslxml', 'application/xsltxml')),
    ...
    'YamlJinjaLexer': ('pip._vendor.pygments.lexers.templates', 'YAMLJinja', ('yamljinja', 'salt', 'sls'), ('*.sls', '*.yaml.j2', '*.yml.j2', '*.yaml.jinja2', '*.yml.jinja2'), ('text/x-yamljinja', 'text/x-sls')),
