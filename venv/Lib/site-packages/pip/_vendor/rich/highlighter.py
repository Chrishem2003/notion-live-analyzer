...
class ISO8601Highlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        # Hours, minutes, and seconds with time zone designator (e.g., 17:21:5907:00).
        ...
        #
        # Date, with optional time zone (e.g., 2008-08-30 or 2008-08-3007:00).
        # Hyphens are required. This is the XML Schema 'date' type
        r"^(?P<date>(?P<year>-?(?:[1-9][0-9]*)?[0-9]{4})-(?P<month>1[0-2]|0[1-9])-(?P<day>3[01]|0[1-9]|[12][0-9]))(?P<timezone>Z|[-](?:2[0-3]|[01][0-9]):[0-5][0-9])?$",
        # Time, with optional fractional seconds and time zone (e.g., 01:45:36 or 01:45:36.12307:00).
...
if __name__ == "__main__":  # pragma: no cover
    ...
    console.print("/foo/bar/baz?foo=baregg&egg=baz")
    console.print("/foo/bar/baz/")
    ...
    console.print("foo /foo/bar/ba._z/egg.py word")
