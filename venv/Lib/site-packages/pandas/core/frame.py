...
class DataFrame(NDFrame, OpsMixin):
    ...
    def memory_usage(self, index: bool = True, deep: bool = False) -> Series:
        ...
        0      1      1.0              1.00.0j       1  True
        1      1      1.0              1.00.0j       1  True
        2      1      1.0              1.00.0j       1  True
        3      1      1.0              1.00.0j       1  True
        4      1      1.0              1.00.0j       1  True
    ...
    def insert(
        ...
        if not allow_duplicates and column in self.columns:
            # Should this be a different kind of errorraise ValueError(f"cannot insert {column}, already exists")
    ...
    def _maybe_align_series_as_frame(self, series: Series, axis: AxisInt):
        ...
        if not isinstance(rvalues, np.ndarray):
            ...
            if lib.is_np_dtype(rvalues.dtype, "mM"):
                ...
                # We can losslesslycheaply cast to ndarray
