...
class Index(IndexOpsMixin, PandasObject):
    ...
    def view(self, cls=None):
        ...
        >>> idx.view("float32")
        array([   nan,    nan, 0.e00, 0.e00, 1.e-45, 0.e00], dtype=float32)
        """
    ...
    def __getitem__(self, key):
        ...
        if com.is_bool_indexer(key):
            # if we have list[bools, length=1e5] then doing this checkconvert
            #  takes 166 Âµs  2.1 ms and cuts the ndarray.__getitem__
            #  time below from 3.8 ms to 496 Âµs
            # if we already have ndarray[bool], the overhead is 1.4 Âµs or .25%
