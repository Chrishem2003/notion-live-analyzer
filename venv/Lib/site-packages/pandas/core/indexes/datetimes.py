...
class DatetimeIndex(DatetimeTimedeltaMixin):
    ...
    ambiguous : 'infer', bool-ndarray, 'NaT', default 'raise'
        ...
        For example in Central European Time (UTC01), when going from 03:00
    ...
    Examples
    --------
    >>> idx = pd.DatetimeIndex(["1/1/2020 10:00:0000:00", "2/1/2020 11:00:0000:00"])
    >>> idx
    DatetimeIndex(['2020-01-01 10:00:0000:00', '2020-02-01 11:00:0000:00'],
    ...
    def tz_convert(self, tz) -> Self:
        ...
        >>> dti
        DatetimeIndex(['2014-08-01 09:00:0002:00',
                       '2014-08-01 10:00:0002:00',
                       '2014-08-01 11:00:0002:00'],
    ...
    def tz_localize(
        ...
        ambiguous : 'infer', 'NaT', bool array, default 'raise'
            When clocks moved backward due to DST, ambiguous times may arise.
            For example in Central European Time (UTC01), when going from
        ...
        0   2018-10-28 01:30:0002:00
        1   2018-10-28 02:00:0002:00
        2   2018-10-28 02:30:0002:00
        3   2018-10-28 02:00:0001:00
        4   2018-10-28 02:30:0001:00
        5   2018-10-28 03:00:0001:00
        6   2018-10-28 03:30:0001:00
        ...
        0   2018-10-28 01:20:0002:00
        1   2018-10-28 02:36:0002:00
        2   2018-10-28 03:46:0001:00
        dtype: datetime64[us, CET]
        ...
        0   2015-03-29 03:00:0002:00
        1   2015-03-29 03:30:0002:00
        dtype: datetime64[ns, Europe/Warsaw]

        >>> s.dt.tz_localize('Europe/Warsaw', nonexistent='shift_backward')
        0   2015-03-29 01:59:59.99999999901:00
        1   2015-03-29 03:30:0002:00
        dtype: datetime64[ns, Europe/Warsaw]

        >>> s.dt.tz_localize('Europe/Warsaw', nonexistent=pd.Timedelta('1h'))
        0   2015-03-29 03:30:0002:00
        1   2015-03-29 03:30:0002:00
        dtype: datetime64[ns, Europe/Warsaw]
        """  # noqa: E501
...
def date_range(
    ...
    **Specifying the values**
    ...
    ... )
    DatetimeIndex(['2018-01-01 00:00:0001:00', '2018-01-02 00:00:0001:00',
                   '2018-01-03 00:00:0001:00', '2018-01-04 00:00:0001:00',
                   '2018-01-05 00:00:0001:00', '2018-01-06 00:00:0001:00',
                   '2018-01-07 00:00:0001:00', '2018-01-08 00:00:0001:00'],
    ...
    **Other Parameters**
    ...
    DatetimeIndex(['2018-01-01 00:00:0009:00', '2018-01-02 00:00:0009:00',
                   '2018-01-03 00:00:0009:00', '2018-01-04 00:00:0009:00',
                   '2018-01-05 00:00:0009:00'],
