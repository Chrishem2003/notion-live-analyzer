...
class StringMethods(NoNewAttributesMixin):
    ...
    def slice(self, start=None, stop=None, step=None):
        ...
        Series.str.get : Return element at position.
            Equivalent to `Series.str.slice(start=i, stop=i1)` with `i`
            being the position.
    ...
    def wrap(
        ...
        fix_sentence_endings : bool, optional
            ...
            difference between â€œDr.â€ in `[...] Dr. Frankenstein's monster [...]`
            and â€œSpot.â€ in `[...] See Spot. See Spot run [...]`
            Since the sentence detection algorithm relies on string.lowercase
            for the definition of â€œlowercase letterâ€, and a convention of using
    ...
    def isdigit(self):
        ...
        For example, Python considers the Â³ superscript character as a digit, but
        not the â…• fraction character, while PyArrow considers both as digits. For
    ...
    def isascii(self):
        ...
        >>> s5 = pd.Series(["Ã¶", "see123", "hello world", ""])
        >>> s5.str.isascii()
        0    False
        1     True
        2     True
