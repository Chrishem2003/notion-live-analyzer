...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    def tz(self) -> tzinfo | None:
        ...
        >>> s = pd.Series(["1/1/2020 10:00:0000:00", "2/1/2020 11:00:0000:00"])
        >>> s = pd.to_datetime(s)
        >>> s
        0   2020-01-01 10:00:0000:00
        1   2020-02-01 11:00:0000:00
        ...
        ...     ["1/1/2020 10:00:0000:00", "2/1/2020 11:00:0000:00"]
        ... )
        >>> idx.tz
        datetime.timezone.utc
        """  # noqa: E501
...
default 'raise'
    ...
    def normalize(self) -> Self:
        ...
        ... )
        >>> idx
        DatetimeIndex(['2014-08-01 10:00:0005:30',
                       '2014-08-01 11:00:0005:30',
                       '2014-08-01 12:00:0005:30'],
                        dtype='datetime64[us, Asia/Calcutta]', freq='h')
        >>> idx.normalize()
        DatetimeIndex(['2014-08-01 00:00:0005:30',
                       '2014-08-01 00:00:0005:30',
                       '2014-08-01 00:00:0005:30'],
    ...
    def month_name(self, locale=None) -> npt.NDArray[np.object_]:
        ...
        Index(['Janeiro', 'Fevereiro', 'Mar̤o'], dtype='str')
        """
        values = self._local_timestamps()
    ...
    def day_name(self, locale=None) -> npt.NDArray[np.object_]:
        ...
        Index(['Segunda', 'Ter̤a', 'Quarta'], dtype='str')
        """
        values = self._local_timestamps()
    ...
    day_of_year = _field_accessor(
        ...
        >>> idx = pd.DatetimeIndex(["1/1/2020 10:00:0000:00",
        ...                         "2/1/2020 11:00:0000:00"])
        >>> idx.dayofyear
    ...
    quarter = _field_accessor(
        ...
        >>> s = pd.Series(["1/1/2020 10:00:0000:00", "4/1/2020 11:00:0000:00"])
        >>> s = pd.to_datetime(s)
        >>> s
        0   2020-01-01 10:00:0000:00
        1   2020-04-01 11:00:0000:00
        dtype: datetime64[us, UTC]
        >>> s.dt.quarter
        0    1
        1    2
