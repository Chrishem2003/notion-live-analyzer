...
class TestDateTimeConverter:
    ...
    def test_conversion(self, dtc):
        ...
        rs = dtc.convert("2012-01-01 00:00:000000", None, None)
        assert rs == xp

        rs = dtc.convert(
            np.array(["2012-01-01 00:00:000000", "2012-01-02 00:00:000000"]),
            None,
            None,
        )
        assert rs[0] == xp
...
class TestPeriodConverter:
    ...
    def test_conversion(self, pc, axis):
        ...
        rs = pc.convert("2012-01-01 00:00:000000", None, axis)
        assert rs == xp
