...
class TestSeriesFillNA:
    ...
    def test_fillna_dt64tz_with_method(self):
        # with timezone
        # GH#15855
        ser = Series([Timestamp("2012-11-11 00:00:0001:00").as_unit("s"), NaT])
        exp = Series(
            [
                Timestamp("2012-11-11 00:00:0001:00").as_unit("s"),
                Timestamp("2012-11-11 00:00:0001:00").as_unit("s"),
            ]
        )
        tm.assert_series_equal(ser.ffill(), exp)

        ser = Series([NaT, Timestamp("2012-11-11 00:00:0001:00").as_unit("s")])
        exp = Series(
            [
                Timestamp("2012-11-11 00:00:0001:00").as_unit("s"),
                Timestamp("2012-11-11 00:00:0001:00").as_unit("s"),
