...
@pytest.mark.parametrize(
    "data,output",
    [
        ([2, complex("nan"), 1], [" 2.00.0j", " NaN0.0j", " 1.00.0j"]),
        ([2, complex("nan"), -1], [" 2.00.0j", " NaN0.0j", "-1.00.0j"]),
        ([-2, complex("nan"), -1], ["-2.00.0j", " NaN0.0j", "-1.00.0j"]),
        ([-1.23j, complex("nan"), -1], ["-0.00-1.23j", "  NaN0.00j", "-1.000.00j"]),
        ([1.23j, complex("nan"), 1.23], [" 0.001.23j", "  NaN0.00j", " 1.230.00j"]),
        (
            [-1.23j, complex(np.nan, np.nan), 1],
            ["-0.00-1.23j", "  NaN NaNj", " 1.000.00j"],
        ),
        (
            [-1.23j, complex(1.2, np.nan), 1],
            ["-0.00-1.23j", " 1.20 NaNj", " 1.000.00j"],
        ),
        (
            [-1.23j, complex(np.nan, -1.2), 1],
            ["-0.00-1.23j", "  NaN-1.20j", " 1.000.00j"],
        ),
    ],
)
