...
class TestAstype:
    ...
    def test_astype_dt64tz(self, timezone_frame):
        ...
        expected = np.array(
            [
                ...
                [
                    Timestamp("2013-01-01 00:00:000100", tz="CET"),
                    NaT,
                    Timestamp("2013-01-03 00:00:000100", tz="CET"),
                ],
            ],
            dtype=object,
        ).T
    ...
    def test_astype_dt64tz_to_str(self, timezone_frame, using_infer_string):
        ...
        expected = DataFrame(
            [
                [
                    ...
                    "2013-01-01 00:00:0001:00",
                ],
                ["2013-01-02", na_value, na_value],
                [
                    "2013-01-03",
                    "2013-01-03 00:00:00-05:00",
                    "2013-01-03 00:00:0001:00",
                ],
            ],
            columns=timezone_frame.columns,
            dtype="str",
        ...
        with option_context("display.max_columns", 20):
            ...
            assert (
                "0 2013-01-01 2013-01-01 00:00:00-05:00 2013-01-01 00:00:0001:00"
            ) in result
            assert (
                "1 2013-01-02                       NaT                       NaT"
            ) in result
            assert (
                "2 2013-01-03 2013-01-03 00:00:00-05:00 2013-01-03 00:00:0001:00"
            ) in result
