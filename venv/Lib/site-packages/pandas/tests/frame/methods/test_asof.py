...
class TestFrameAsof:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                Timestamp("2018-01-01 23:22:43.32500:00"),
                Series(2, name=Timestamp("2018-01-01 23:22:43.32500:00")),
            ),
            (
                Timestamp("2018-01-01 22:33:20.68201:00"),
                Series(1, name=Timestamp("2018-01-01 22:33:20.68201:00")),
            ),
        ],
    )
    def test_time_zone_aware_index(self, stamp, expected):
        ...
        df = DataFrame(
            data=[1, 2],
            index=[
                Timestamp("2018-01-01 21:00:05.00100:00"),
                Timestamp("2018-01-01 22:35:10.55000:00"),
            ],
        )
