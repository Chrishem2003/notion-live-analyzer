...
class TestWeek:
    ...
    @pytest.mark.parametrize(
        "n,date",
        [
            (2, "1862-01-13 09:03:34.8734773780210"),
...
class TestWeekOfMonth:
    ...
    @pytest.mark.parametrize(
        "n,week,date,tz",
        [
            (2, 2, "1916-05-15 01:14:49.5834104620422", "Asia/Qyzylorda"),
            (-3, 1, "1980-12-08 03:38:52.8783211850500", "Asia/Oral"),
        ],
    )
...
class TestLastWeekOfMonth:
    ...
    @pytest.mark.parametrize(
        "n,weekday,date,tz",
        [
            (4, 6, "1917-05-27 20:55:27.0842841780200", "Europe/Warsaw"),
