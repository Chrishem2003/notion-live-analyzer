...
class TestTableSchemaRepr:
    def test_publishes(self, ip):
        ...
        expected_keys = [
            {"text/plain", "application/vnd.dataresourcejson"},
            {"text/plain", "text/html", "application/vnd.dataresourcejson"},
        ]
        ...
        expected = {
            ...
            "text/html",
            "text/latex",
            "application/vnd.dataresourcejson",
        }
        assert set(formatted[0].keys()) == expected
    ...
    def test_enable_data_resource_formatter(self, ip):
        ...
        mimetype = "application/vnd.dataresourcejson"

        with cf.option_context("display.html.table_schema", True):
            assert "application/vnd.dataresourcejson" in formatters
