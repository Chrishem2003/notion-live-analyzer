...
class TestDataFrameFormatting:
    ...
    def test_east_asian_unicode_false(self):
        ...
        # mid col
        df = DataFrame(
            {"a": ["ã‚", "ã„ã„ã„", "ã†", "ãˆãˆãˆãˆãˆãˆ"], "b": [1, 222, 33333, 4]},
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            "          a      b\na         ã‚      1\n"
            "bb      ã„ã„ã„    222\nc         ã†  33333\n"
            "ddd  ãˆãˆãˆãˆãˆãˆ      4"
        )
        assert repr(df) == expected

        # last col
        df = DataFrame(
            {"a": [1, 222, 33333, 4], "b": ["ã‚", "ã„ã„ã„", "ã†", "ãˆãˆãˆãˆãˆãˆ"]},
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            "         a       b\na        1       ã‚\n"
            "bb     222     ã„ã„ã„\nc    33333       ã†\n"
            "ddd      4  ãˆãˆãˆãˆãˆãˆ"
        )
        assert repr(df) == expected
        ...
        df = DataFrame(
            {
                "a": ["ã‚ã‚ã‚ã‚ã‚", "ã„", "ã†", "ãˆãˆãˆ"],
                "b": ["ã‚", "ã„ã„ã„", "ã†", "ãˆãˆãˆãˆãˆãˆ"],
            },
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            "         a       b\na    ã‚ã‚ã‚ã‚ã‚       ã‚\n"
            "bb       ã„     ã„ã„ã„\nc        ã†       ã†\n"
            "ddd    ãˆãˆãˆ  ãˆãˆãˆãˆãˆãˆ"
        )
        assert repr(df) == expected
        ...
        df = DataFrame(
            ...
            index=["ã‚ã‚ã‚", "ã„ã„ã„ã„ã„ã„", "ã†ã†", "ãˆ"],
        )
        expected = (
            "            a       b\nã‚ã‚ã‚     ã‚ã‚ã‚ã‚ã‚       ã‚\n"
            "ã„ã„ã„ã„ã„ã„      ã„     ã„ã„ã„\nã†ã†          ã†       ã†\n"
            "ãˆ         ãˆãˆãˆ  ãˆãˆãˆãˆãˆãˆ"
        )
        assert repr(df) == expected
        ...
        df = DataFrame(
            ...
            index=Index(["ã‚", "ã„", "ã†ã†", "ãˆ"], name="ãŠãŠãŠãŠ"),
        )
        expected = (
            "          a       b\n"
            "ãŠãŠãŠãŠ               \n"
        ...
        df = DataFrame(
            {
                "ã‚ã‚ã‚": ["ã‚ã‚ã‚", "ã„", "ã†", "ãˆãˆãˆãˆãˆ"],
                "ã„ã„ã„ã„ã„": ["ã‚", "ã„ã„ã„", "ã†", "ãˆãˆ"],
            },
            index=Index(["ã‚", "ã„ã„ã„", "ã†ã†", "ãˆ"], name="ãŠ"),
        )
        expected = (
            "       ã‚ã‚ã‚ ã„ã„ã„ã„ã„\n"
            "ãŠ               \n"
            ...
            "ã„ã„ã„      ã„   ã„ã„ã„\n"
            "ã†ã†       ã†     ã†\n"
            "ãˆ    ãˆãˆãˆãˆãˆ    ãˆãˆ"
        )
        assert repr(df) == expected

        # MultiIndex
        idx = MultiIndex.from_tuples(
            [("ã‚", "ã„ã„"), ("ã†", "ãˆ"), ("ãŠãŠãŠ", "ã‹ã‹ã‹ã‹"), ("ã", "ãã")]
        )
        df = DataFrame(
            {
                "a": ["ã‚ã‚ã‚ã‚ã‚", "ã„", "ã†", "ãˆãˆãˆ"],
        ...
        expected = (
            ...
            "ã‚   ã„ã„    ã‚ã‚ã‚ã‚ã‚       ã‚\n"
            "ã†   ãˆ         ã„     ã„ã„ã„\n"
            "ãŠãŠãŠ ã‹ã‹ã‹ã‹      ã†       ã†\n"
            "ã   ãã      ãˆãˆãˆ  ãˆãˆãˆãˆãˆãˆ"
        )
        assert repr(df) == expected
            ...
            df = DataFrame(
                {
                    "a": ["ã‚ã‚ã‚ã‚ã‚", "ã„", "ã†", "ãˆãˆãˆ"],
                    "b": ["ã‚", "ã„ã„ã„", "ã†", "ãˆãˆãˆãˆãˆãˆ"],
                    "c": ["ãŠ", "ã‹", "ããã", "ãããããã"],
                    "ã‚ã‚ã‚ã‚": ["ã•", "ã—", "ã™", "ã›"],
                },
                columns=["a", "b", "c", "ã‚ã‚ã‚ã‚"],
            )
    ...
    def test_east_asian_unicode_true(self):
        ...
        with option_context("display.unicode.east_asian_width", True):
            ...
            df = DataFrame(
                {
                    "b": ["ã‚", "ã„ã„ã„", "Â¡Â¡", "ãˆãˆãˆãˆãˆãˆ"],
                    "ã‚ã‚ã‚ã‚ã‚": [1, 222, 33333, 4],
                },
                index=["a", "bb", "c", "Â¡Â¡Â¡"],
            )
    ...
    def test_datetimelike_frame(self):
        ...
        with option_context("display.max_rows", 5):
            result = str(df)
            assert "2013-01-01 00:00:0000:00" in result
        ...
        with option_context("display.max_rows", 5):
            expected = (
                "                           dt   x\n"
                "0   2011-01-01 00:00:0009:00   1\n"
                "1   2011-01-01 00:00:0009:00   2\n"
                "..                        ...  ..\n"
                "8   2011-01-01 00:00:00-05:00   9\n"
                "9   2011-01-01 00:00:00-05:00  10\n\n"
                "[10 rows x 2 columns]"
...
class TestSeriesFormatting:
    ...
    def test_east_asian_unicode_series(self, using_infer_string):
        ...
        # unicode index
        s = Series(["a", "bb", "CCC", "D"], index=["ã‚", "ã„ã„", "ã†ã†ã†", "ãˆãˆãˆãˆ"])
        expected = "".join(
            [
                "ã‚         a\n",
                "ã„ã„       bb\n",
        ...
        # unicode values
        s = Series(["ã‚", "ã„ã„", "ã†ã†ã†", "ãˆãˆãˆãˆ"], index=["a", "bb", "c", "ddd"])
        expected = "".join(
            [
                "a         ã‚\n",
                "bb       ã„ã„\n",
        ...
        # both
        s = Series(
            ["ã‚", "ã„ã„", "ã†ã†ã†", "ãˆãˆãˆãˆ"],
            index=["ã‚ã‚", "ã„ã„ã„ã„", "ã†", "ãˆãˆãˆ"],
        )
        expected = "".join(
            [
                "ã‚ã‚         ã‚\n",
        ...
        s = Series(
            ["ã‚", "ã„ã„", "ã†ã†ã†", "ãˆãˆãˆãˆ"],
            index=["ã‚ã‚", "ã„ã„ã„ã„", "ã†", "ãˆãˆãˆ"],
            name="ãŠãŠãŠãŠãŠãŠãŠ",
        )
        expected = (
            "ã‚ã‚         ã‚\nã„ã„ã„ã„      ã„ã„\nã†        ã†ã†ã†\n"
            "ãˆãˆãˆ     ãˆãˆãˆãˆ\nName: ãŠãŠãŠãŠãŠãŠãŠ, dtype: object"
        )
        if using_infer_string:
            expected = expected.replace("dtype: object", "dtype: str")
        assert repr(s) == expected
        ...
        expected = (
            "ã‚    ã„ã„          1\n"
            "ã†    ãˆ          22\n"
            "ãŠãŠãŠ  ã‹ã‹ã‹ã‹     3333\n"
            "ã    ãã      44444\ndtype: int64"
        )
        assert repr(s) == expected

        # object dtype, shorter than unicode repr
        s = Series([1, 22, 3333, 44444], index=[1, "AB", np.nan, "ã‚ã‚ã‚"])
        expected = (
            "1          1\nAB        22\nNaN     3333\nã‚ã‚ã‚    44444\ndtype: int64"
        )
        assert repr(s) == expected
        ...
        s = Series(
            [1, 22, 3333, 44444], index=[1, "AB", Timestamp("2011-01-01"), "ã‚ã‚ã‚"]
        )
        expected = (
            "1                          1\n"
            "AB                        22\n"
        ...
        with option_context("display.max_rows", 3):
            s = Series(["ã‚", "ã„ã„", "ã†ã†ã†", "ãˆãˆãˆãˆ"], name="ãŠãŠãŠãŠãŠãŠãŠ")

            expected = (
                "0       ã‚\n     ... \n"
                "3    ãˆãˆãˆãˆ\n"
                "Name: ãŠãŠãŠãŠãŠãŠãŠ, Length: 4, dtype: object"
            )
            if using_infer_string:
                expected = expected.replace("dtype: object", "dtype: str")
            assert repr(s) == expected

            s.index = ["ã‚ã‚", "ã„ã„ã„ã„", "ã†", "ãˆãˆãˆ"]
            expected = (
                "ã‚ã‚        ã‚\n       ... \n"
                "ãˆãˆãˆ    ãˆãˆãˆãˆ\n"
                "Name: ãŠãŠãŠãŠãŠãŠãŠ, Length: 4, dtype: object"
        ...
        with option_context("display.unicode.east_asian_width", True):
            ...
            s = Series(
                ["a", "bb", "CCC", "D"],
                index=["ã‚", "ã„ã„", "ã†ã†ã†", "ãˆãˆãˆãˆ"],
            )
            expected = (
                "ã‚            a\nã„ã„         bb\nã†ã†ã†      CCC\n"
                "ãˆãˆãˆãˆ      D\ndtype: object"
            ...
            s = Series(
                [1, 22, 3333, 44444],
                index=[1, "AB", Timestamp("2011-01-01"), "ã‚ã‚ã‚"],
            )
            expected = (
                "1                          1\n"
                "AB                        22\n"
            ...
            # ambiguous unicode
            s = Series(
                ["Â¡Â¡", "ã„Â¡Â¡", "ã†ã†ã†", "ãˆãˆãˆãˆ"],
                index=["ã‚ã‚", "Â¡Â¡Â¡Â¡ã„ã„", "Â¡Â¡", "ãˆãˆãˆ"],
            )
            expected = (
                "ã‚ã‚              Â¡Â¡\n"
                "Â¡Â¡Â¡Â¡ã„ã„        ã„Â¡Â¡\n"
...
@pytest.mark.parametrize(
    "encoding, data",
    [(None, "abc"), ("utf-8", "abc"), ("gbk", "é€ æˆè¾“å‡ºä¸­æ–‡æ˜¾ç¤ºä¹±ç "), ("foo", "abc")],
)
