...
def test_parse_tz_aware(all_parsers):
    ...
    expected = DataFrame(
        {"x": [0.5]}, index=Index([Timestamp("2012-06-13 01:39:0000:00")], name="Date")
    )
    if parser.engine == "pyarrow":
...
def test_parse_timezone(all_parsers):
    ...
    parser = all_parsers
    data = """dt,val
              2018-01-04 09:01:0009:00,23350
              2018-01-04 09:02:0009:00,23400
              2018-01-04 09:03:0009:00,23400
              2018-01-04 09:04:0009:00,23400
              2018-01-04 09:05:0009:00,23400"""
...
def test_from_csv_with_mixed_offsets(all_parsers):
    parser = all_parsers
    data = "a\n2020-01-01T00:00:0001:00\n2020-01-01T00:00:0000:00"
