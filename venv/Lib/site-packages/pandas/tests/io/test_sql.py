...
def mysql_pymysql_engine():
    ...
    engine = sqlalchemy.create_engine(
        "mysqlpymysql://root@localhost:3306/pandas",
...
def postgresql_psycopg2_engine():
    ...
    engine = sqlalchemy.create_engine(
        "postgresqlpsycopg2://postgres:postgres@localhost:5432/pandas",
        poolclass=sqlalchemy.pool.NullPool,
    )
    yield engine
    for view in get_all_views(engine):
...
def test_api_table_name_quoted(conn, request):
    ...
    # to_sql: adbc_ingest handles quoting internally â€” should pass
...
def test_pg8000_sqlalchemy_passthrough_error(request):
    ...
    db_uri = "postgresqlpg8000://user:pass@host/dbname"
