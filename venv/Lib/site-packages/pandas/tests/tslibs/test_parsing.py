...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("2011-12-30T00:00:009", "%Y-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:0009", "%Y-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00090", None),
        ("2011-12-30T00:00:000900", "%Y-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00-0900", "%Y-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:0009:00", "%Y-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:0009:000", None),
        ("2011-12-30T00:00:009:0", "%Y-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:0009:", None),
        ("2011-12-30T00:00:00.000000UTC", "%Y-%m-%dT%H:%M:%S.%f%Z"),
        ("2011-12-30T00:00:00.000000Z", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.0000009", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.00000009", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000090", None),
        ("2011-12-30T00:00:00.0000000900", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000-0900", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.00000009:00", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.00000009:000", None),
        ("2011-12-30T00:00:00.0000009:0", "%Y-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.00000009:", None),
