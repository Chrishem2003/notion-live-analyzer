...
@pytest.mark.parametrize(
    ...
    [
        ["01-01-2013 08:00:0008:00", 480],
        ["2013-01-01T08:00:00.0000000000800", 480],
...
def test_parsing_non_iso_timezone_offset():
    dt_string = "01-01-2013T00:00:00.0000000000000"
    arr = np.array([dt_string], dtype=object)
...
def test_parsing_different_timezone_offsets():
    # see gh-17697
    data = ["2015-11-18 15:30:0005:30", "2015-11-18 15:30:0006:30"]
