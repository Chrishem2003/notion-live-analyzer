...
class TestTimestampConstructorFoldKeyword:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("2019-10-27 01:30:0001:00", 0),
            ("2019-10-27 01:30:0000:00", 1),
...
class TestTimestampResolutionInference:
    ...
    def test_constructor_str_infer_reso(self):
        ...
        ts = Timestamp("01-01-2013T00:00:00.0000000000000")
        assert ts.unit == "ns"
        ...
        ts = Timestamp("01-01-2013T00:00:00.0000000021000000")
        assert ts == Timestamp("01-01-2013T00:00:00.0000000020000")
        assert ts.unit == "ns"

        # GH#56208 minute reso through the ISO8601 path with tz offset
        ts = Timestamp("2020-01-01 00:0000:00")
        assert ts.unit == "us"

        ts = Timestamp("2020-01-01 0000:00")
        assert ts.unit == "us"
...
class TestTimestampConstructors:
    ...
    def test_constructor_with_stringoffset(self):
        # GH 7833
        base_str = "2014-07-01 11:00:0002:00"
        base_dt = datetime(2014, 7, 1, 9)
        base_expected = 1_404_205_200_000_000_000
        ...
        tests = [
            ...
            ("2014-07-01 12:00:0002:00", base_expected  3600 * 1_000_000_000),
            ("2014-07-01 11:00:00.00000800002:00", base_expected  8000),
            ("2014-07-01 11:00:00.00000000502:00", base_expected  5),
        ]
        ...
        assert result._value == Timestamp("2013-11-01 05:00")._value
        expected = "Timestamp('2013-11-01 14:00:000900', tz='Asia/Tokyo')"
        assert repr(result) == expected
        assert result == eval(repr(result))
        ...
        result = Timestamp("2015-11-18 15:45:0005:45", tz="Asia/Katmandu")
        assert result._value == Timestamp("2015-11-18 10:00")._value
        expected = "Timestamp('2015-11-18 15:45:000545', tz='Asia/Katmandu')"
        assert repr(result) == expected
        assert result == eval(repr(result))

        # This should be 2015-11-18 10:00 in UTC
        # converted to Asia/Kolkata
        result = Timestamp("2015-11-18 15:30:0005:30", tz="Asia/Kolkata")
        assert result._value == Timestamp("2015-11-18 10:00")._value
        expected = "Timestamp('2015-11-18 15:30:000530', tz='Asia/Kolkata')"
        assert repr(result) == expected
        assert result == eval(repr(result))
    ...
    @pytest.mark.parametrize(
        "arg", ["2013/01/01 00:00:0009:00", "2013-01-01 00:00:0009:00"]
    )
    ...
    def test_timestamp_constructor_near_dst_boundary(self):
        ...
        expected = Timestamp("2017-03-26 00:00:000100", tz="Europe/Paris")
        assert result == expected

        result = Timestamp("2017-03-26 01:00", tz="Europe/Paris")
        expected = Timestamp("2017-03-26 01:00:000100", tz="Europe/Paris")
        assert result == expected
        ...
        result = Timestamp("2017-03-26 02:00:000100", tz="Europe/Paris")
        naive = Timestamp(result.as_unit("ns")._value)
        expected = naive.tz_localize("UTC").tz_convert("Europe/Paris")
        assert result == expected

        result = Timestamp("2017-03-26 03:00", tz="Europe/Paris")
        expected = Timestamp("2017-03-26 03:00:000200", tz="Europe/Paris")
        assert result == expected
