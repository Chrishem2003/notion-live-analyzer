...
class TestDatetimeIndexRendering:
    ...
    def test_dti_representation(self, unit):
        ...
        exp.append(
            "DatetimeIndex(['2011-01-01 09:00:0009:00', "
            "'2011-01-01 10:00:0009:00', '2011-01-01 11:00:0009:00']"
        ...
        exp.append(
            "DatetimeIndex(['2011-01-01 09:00:0000:00', "
            "'2011-01-01 10:00:0000:00', 'NaT'], "
    ...
    def test_dti_representation_to_series(self, unit):
        ...
        exp5 = (
            "0   2011-01-01 09:00:0009:00\n"
            "1   2011-01-01 10:00:0009:00\n"
            "2   2011-01-01 11:00:0009:00\n"
    ...
    def test_dti_summary(self):
        ...
        exp5 = (
            "DatetimeIndex: 3 entries, 2011-01-01 09:00:0009:00 "
            "to 2011-01-01 11:00:0009:00\n"
            "Freq: h"
        )
