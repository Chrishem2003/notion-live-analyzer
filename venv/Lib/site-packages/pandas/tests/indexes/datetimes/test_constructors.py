...
class TestDatetimeIndex:
    ...
    def test_constructor_datetime64_tzformat(self, freq):
        ...
        idx = date_range(
            "2013-01-01T00:00:0009:00", "2016-01-01T23:59:5909:00", freq=freq
        )
        expected = date_range(
            "2013-01-01T00:00:00",
            "2016-01-01T23:59:59",
        ...
        idx = date_range("2013/1/1 0:00:009:00", "2016/1/1 23:59:5909:00", freq=freq)
        expected = date_range(
            "2013-01-01T00:00:00",
            "2016-01-01T23:59:59",
            freq=freq,
    ...
    def test_constructor_timestamp_near_dst(self):
        # GH 20854
        ts = [
            Timestamp("2016-10-30 03:00:000300", tz="Europe/Helsinki"),
            Timestamp("2016-10-30 03:00:000200", tz="Europe/Helsinki"),
        ]
    ...
    def test_constructor_with_nonexistent_keyword_arg(self, warsaw):
        ...
        expected = DatetimeIndex(
            [
                Timestamp("2015-03-29 03:00:0002:00", tz=timezone),
                Timestamp("2015-03-29 04:00:0002:00", tz=timezone),
            ]
        ).as_unit("ns")
        ...
        expected = DatetimeIndex(
            [
                Timestamp("2015-03-29 01:00:0001:00", tz=timezone),
                Timestamp("2015-03-29 03:00:0002:00", tz=timezone),
            ]
        ).as_unit("ns")
