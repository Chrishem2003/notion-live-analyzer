...
class TestSlicing:
    ...
    @pytest.mark.parametrize(
        "start",
        [
            "2018-12-02 21:50:0000:00",
            Timestamp("2018-12-02 21:50:0000:00"),
            Timestamp("2018-12-02 21:50:0000:00").to_pydatetime(),
        ],
    )
    @pytest.mark.parametrize(
        "end",
        [
            "2018-12-02 21:52:0000:00",
            Timestamp("2018-12-02 21:52:0000:00"),
            Timestamp("2018-12-02 21:52:0000:00").to_pydatetime(),
        ],
    )
