...
class TestDateRanges:
    ...
    def test_date_range_convenience_periods(self, unit):
        ...
        expected = DatetimeIndex(
            [
                Timestamp("2018-04-01 01:00:001100", tz="Australia/Sydney"),
                Timestamp("2018-04-01 02:00:001000", tz="Australia/Sydney"),
                Timestamp("2018-04-01 04:00:001000", tz="Australia/Sydney"),
            ]
        ).as_unit(unit)
        tm.assert_index_equal(result, expected)
    ...
    def test_construct_with_different_start_end_string_format(self, unit):
        # GH 12064
        result = date_range(
            "2013-01-01 00:00:0009:00",
            "2013/01/01 02:00:0009:00",
            freq="h",
            unit=unit,
        )
        expected = DatetimeIndex(
            [
                Timestamp("2013-01-01 00:00:0009:00"),
                Timestamp("2013-01-01 01:00:0009:00"),
                Timestamp("2013-01-01 02:00:0009:00"),
            ],
            freq="h",
        ).as_unit(unit)
        tm.assert_index_equal(result, expected)
...
class TestDateRangeTZ:
    ...
    def test_date_range_with_fixed_tz(self):
        ...
        rng3 = date_range("3/11/2012 05:00:0007:00", "6/11/2012 05:00:0007:00")
    ...
    def test_date_range_ambiguous_endpoint(self, tz):
        ...
        assert times[-1] == Timestamp("2013-10-27 01:00:000000", tz=tz)
...
class TestCustomDateRange:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("2022-07-23 00:00:0002:00", 1, ["2022-07-25 00:00:0002:00"]),
            ("2022-07-22 00:00:0002:00", 1, ["2022-07-22 00:00:0002:00"]),
            (
                "2022-07-22 00:00:0002:00",
                2,
                ["2022-07-22 00:00:0002:00", "2022-07-25 00:00:0002:00"],
            ),
        ],
    )
