...
class TestTimeConversionFormats:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "%Y-%m-%d %H:%M:%S.%f%z",
                Timestamp(2000, 1, 3, 12, 34, 56, 123456, tz="UTC01:00"),
            ),
            (
                "%Y-%d-%m %H:%M:%S.%f%z",
                Timestamp(2000, 3, 1, 12, 34, 56, 123456, tz="UTC01:00"),
            ),
        ],
    )
    def test_non_exact_doesnt_parse_whole_string(self, cache, format, expected):
        ...
        result = to_datetime(
            "2000-01-03 12:34:56.12345601:00", format=format, exact=False
        )
        assert result == expected
    ...
    def test_to_datetime_parse_tzname_or_tzoffset_different_tz_to_utc(self):
        ...
        expected_dates = [
            "2010-01-01 11:00:0000:00",
            "2010-01-01 13:00:0000:00",
            "2010-01-01 09:00:0000:00",
            "2010-01-01 08:00:0000:00",
        ]
        fmt = "%Y-%m-%d %H:%M:%S %z"
...
class TestToDatetime:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                ...
                DatetimeIndex(
                    ["2000-01-01 09:00:0000:00", "2000-01-01 10:00:0000:00"],
            ...
            pytest.param(
                False,
                ["2000-01-01 01:00:0000:00", "2000-01-01 02:00:0000:00"],
                DatetimeIndex(
                    ["2000-01-01 01:00:0000:00", "2000-01-01 02:00:0000:00"],
                ).as_unit("us"),
            ...
            pytest.param(
                True,
                ["2000-01-01 01:00:00-08:00", "2000-01-01 02:00:0000:00"],
                DatetimeIndex(
                    ["2000-01-01 09:00:0000:00", "2000-01-01 02:00:0000:00"],
                    dtype="datetime64[us, UTC]",
                ),
            ...
            pytest.param(
                True,
                ["2000-01-01 01:00:00", "2000-01-01 02:00:0000:00"],
                DatetimeIndex(
                    ["2000-01-01 01:00:0000:00", "2000-01-01 02:00:0000:00"],
                    dtype="datetime64[us, UTC]",
                ),
    ...
    def test_to_datetime_mixed_dt_and_str_with_format_mixed_offsets_utc_false_removed(
        ...
        # note: ISO8601 formats go down a fastpath, so we need to check both
        # an ISO8601 format and a non-ISO8601 one
        args = ["2000-01-01 01:00:00", "2000-01-01 02:00:0000:00"]
        ts1 = constructor(args[0])
        ts2 = args[1]
        msg = "Mixed timezones detected. Pass utc=True in to_datetime"
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                "%Y-%m-%d %H:%M:%S%z",
                [
                    Timestamp("2000-01-01 09:00:000100", tz="UTC01:00"),
                    Timestamp("2000-01-02 02:00:000200", tz="UTC02:00"),
                    NaT,
                ],
                id="ISO8601, non-UTC",
            ),
            pytest.param(
                ...
                [
                    Timestamp("2000-01-01 09:00:000100", tz="UTC01:00"),
                    Timestamp("2000-02-01 02:00:000200", tz="UTC02:00"),
                    NaT,
                ],
    ...
    def test_to_datetime_mixed_offsets_with_none_tz_utc_false_removed(
        ...
        with pytest.raises(ValueError, match=msg):
            to_datetime(
                ["2000-01-01 09:00:0001:00", "2000-01-02 02:00:0002:00", None],
                format=fmt,
                utc=False,
            )
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                "%Y-%m-%d %H:%M:%S%z",
                DatetimeIndex(
                    ["2000-01-01 08:00:0000:00", "2000-01-02 00:00:0000:00", "NaT"],
                    dtype="datetime64[us, UTC]",
                ),
                id="ISO8601, UTC",
            ),
            pytest.param(
                "%Y-%d-%m %H:%M:%S%z",
                DatetimeIndex(
                    ["2000-01-01 08:00:0000:00", "2000-02-01 00:00:0000:00", "NaT"],
                    dtype="datetime64[us, UTC]",
                ),
                id="non-ISO8601, UTC",
            ),
    ...
    def test_to_datetime_np_str(self):
        # GH#32264
        # GH#48969
        value = np.str_("2019-02-04 10:18:46.2970000000")
    ...
    def test_to_datetime_different_offsets_removed(self, cache):
        ...
        # GH#57275
        ts_string_1 = "March 1, 2018 12:00:000400"
        ts_string_2 = "March 1, 2018 12:00:000500"
    ...
    def test_to_datetime_tz_pytz(self, cache):
        ...
        expected = DatetimeIndex(
            ["2000-01-01 08:00:0000:00", "2000-06-01 07:00:0000:00"],
            dtype="datetime64[us, UTC]",
            freq=None,
        )
        tm.assert_index_equal(result, expected)
    ...
    def test_to_datetime_coerce(self):
        # GH#26122, GH#57275
        ts_strings = [
            "March 1, 2018 12:00:000400",
            "March 1, 2018 12:00:000500",
            "20100240",
        ]
        msg = "Mixed timezones detected. Pass utc=True in to_datetime"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_iso_8601_strings_with_same_offset(self):
        # GH 17697, 11736
        ts_str = "2015-11-18 15:30:0005:30"
    ...
    def test_iso_8601_strings_with_different_offsets_removed(self):
        ...
        ts_strings = ["2015-11-18 15:30:0005:30", "2015-11-18 16:30:0006:30", NaT]
        msg = "Mixed timezones detected. Pass utc=True in to_datetime"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_non_iso_strings_with_tz_offset(self):
        result = to_datetime(["March 1, 2018 12:00:000400"] * 2)
        expected = DatetimeIndex(
    ...
    @pytest.mark.parametrize(
        "date",
        [
            ["2020-10-26 00:00:0006:00", "2020-10-26 00:00:0001:00"],
            ["2020-10-26 00:00:0006:00", Timestamp("2018-01-01", tz="US/Pacific")],
            [
                "2020-10-26 00:00:0006:00",
...
class TestToDatetimeMisc:
    ...
    @pytest.mark.parametrize(
        "input, format",
        [
            ("2020-01-01T00:00:00.00000000000:00", "%Y-%m-%dT%H:%M:%S.%f%z"),
            ("2020-01-01T00:00:0000:00", "%Y-%m-%dT%H:%M:%S%z"),
...
class TestDatetimeParsingWrappers:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "2013-01-01 05:450545",
                timezone(timedelta(minutes=345)),
                "Timestamp('2013-01-01 05:45:000545', tz='UTC05:45')",
            ),
            (
                "2013-01-01 05:300530",
                timezone(timedelta(minutes=330)),
                "Timestamp('2013-01-01 05:30:000530', tz='UTC05:30')",
            ),
        ],
    )
...
def test_to_datetime_cache_coerce_50_lines_outofbounds(series_length):
    # GH#45319
    ser = Series(
        [datetime.fromisoformat("1446-04-12 00:00:0000:00")]
         ([datetime.fromisoformat("1991-10-20 00:00:0000:00")] * series_length),
        dtype=object,
    )
...
def test_to_datetime_iso8601_utc_single_naive():
    ...
    expected = Timestamp("2023-10-15 14:30:0000:00")
    assert result == expected
...
def test_to_datetime_iso8601_utc_mixed_negative_offset():
    ...
    expected = DatetimeIndex(
        [Timestamp("2023-10-15 22:30:0000:00"), Timestamp("2023-10-15 14:30:0000:00")]
    )
    tm.assert_index_equal(result, expected)
...
def test_to_datetime_iso8601_utc_mixed_positive_offset():
    # GH#61389
    data = ["2023-10-15T10:30:0008:00", "2023-10-15T14:30:00"]
    result = to_datetime(data, utc=True, format="ISO8601")

    expected = DatetimeIndex(
        [Timestamp("2023-10-15 02:30:0000:00"), Timestamp("2023-10-15 14:30:0000:00")]
    )
    tm.assert_index_equal(result, expected)
...
def test_to_datetime_iso8601_utc_mixed_both_offsets():
    ...
    expected = DatetimeIndex(
        [
            Timestamp("2023-10-15 02:30:0000:00"),
            Timestamp("2023-10-15 17:30:0000:00"),
            Timestamp("2023-10-15 14:30:0000:00"),
        ]
    )
    tm.assert_index_equal(result, expected)
...
def test_to_datetime_with_empty_str_utc_false_format_mixed():
    # GH 50887
    vals = ["2020-01-01 00:0000:00", ""]
    result = to_datetime(vals, format="mixed")
    expected = Index([Timestamp("2020-01-01 00:0000:00"), "NaT"], dtype="M8[us, UTC]")
    tm.assert_index_equal(result, expected)
...
def test_to_datetime_with_empty_str_utc_false_offsets_and_format_mixed():
    ...
    with pytest.raises(ValueError, match=msg):
        to_datetime(
            ["2020-01-01 00:0000:00", "2020-01-01 00:0002:00", ""], format="mixed"
        )
