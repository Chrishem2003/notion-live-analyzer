...
def get_default_inventory() -> pd.DataFrame:
    ...
    data = [
        {"ItemID": "RGT-001", "Name": "Taq DNA Polymerase", "Category": "Enzyme", "Quantity": 250, "Unit": "U", "Location": "-20Ã‚Â°C Box A1", "MinThreshold": 50},
        {"ItemID": "RGT-002", "Name": "10x PCR Buffer", "Category": "Buffer", "Quantity": 15, "Unit": "mL", "Location": "-20Ã‚Â°C Box A1", "MinThreshold": 5},
        {"ItemID": "RGT-003", "Name": "dNTP Mix (10mM)", "Category": "Reagent", "Quantity": 2, "Unit": "mL", "Location": "-20Ã‚Â°C Box A2", "MinThreshold": 3},
        {"ItemID": "SMP-101", "Name": "BRCA1 cDNA Isolates", "Category": "Sample", "Quantity": 45, "Unit": "uL", "Location": "-80Ã‚Â°C Rack 3-B", "MinThreshold": 10},
        {"ItemID": "PRM-501", "Name": "Forward Primer 27F", "Category": "Primer", "Quantity": 100, "Unit": "uM", "Location": "-20Ã‚Â°C Box P1", "MinThreshold": 20}
    ]
    return pd.DataFrame(data)

def render_inventory_tab():
    st.subheader("Ã°Å¸Â§Âª Laboratory Inventory & Sample Provenance Engine")
