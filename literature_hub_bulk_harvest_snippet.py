...
It doesn't replace the existing instant search â€” that's genuinely fine for
...
st.markdown("---")
st.markdown("#### ðŸ“¦ Background Bulk Harvest (background job, 100â€“2000 papers)")
st.caption(
...
with col_b3:
    ...
    launch = st.button("ðŸš€ Start Background Harvest", key="bulk_lit_launch", width='stretch')
...
# flight â€” you don't need a while-loop or a separate polling mechanism.
...
if bulk_result is not None:
    ...
    st.dataframe(df_bulk, width='stretch', hide_index=True)
